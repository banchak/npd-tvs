(function() {
  ...
  app.controller('redirectCtrl', ['$routeParams', '$location',
  ...
  app.run(['$route', 'Database', 'APP_CONFIG',
    function($route, Database, APP_CONFIG) {
