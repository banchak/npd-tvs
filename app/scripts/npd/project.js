(function() {
  ...
  angular.module('npd.project', [
    'npd.database', 'controllers.app-auth', 'controllers.legacy-image-list',
    'controllers.legacy-gdrive-list', 'controllers.legacy-gcalendar-list', 'npd.image-sync',
    'npd.product-edit', 'npd.person-edit', 'npd.voucher-edit', 'modules.utils'
  ])
  ...
  .service('APP_CONFIG', ['$rootScope', 'utils',
    function($rootScope, utils) {
      ...
      this.appMenu = {
        title: 'Npd3',
        version: '0.7.1.0 2013-10-18 jsat66@gmail.com',
        menus: [
                  ...
                  if (scope.adminView && ctrl.name == 'persons') {
                    scope.adminView = {
                      actions: function(data) {
                        ...
                        actions.push(_action('vouchers')(null, 'เอกสาร ที่เกี่ยวข้อง', null, {
                          scopes: JSON.stringify(['\'' + data._name])
                        }))
